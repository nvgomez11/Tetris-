...
public class Ele_invertida extends Figura {
    int posicionActual;
    private int cuadritosOcupa[][] = new int[4][2];


    public Ele_invertida(int pid, String pcolor, int pPosicionActual,int f1, int c1, int f2, int c2, int f3, int c3, int f4, int c4) {
        super(pid, pcolor);
